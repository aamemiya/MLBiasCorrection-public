...
def traintest(plist):
    ...
    print(len(list(analysis_dataset)))
    ...
    print(len(list(tfdataset_analysis_train)))
    #Zipping the files
...
#    print(plist['global_batch_size'])
#    print(plist['global_batch_size_v'])
    print(len(list(dataset_train)))
    ...
    print(len(list(train_dataset_dist)))
#    quit()
