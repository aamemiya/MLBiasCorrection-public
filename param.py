...
param_model['b'] = 10
param_model['c'] = 4
param_model['amp_const_nature'] = 0
param_model['amp_const_model'] = 0

param_letkf = {}
param_letkf['obs_error'] = 0.10
param_letkf['obs_number'] =8
param_letkf['localization_length_scale'] = 3
param_letkf['localization_length_cutoff'] = 8
param_letkf['inflation_factor'] = 2.1
...
param_exp['obs_type'] = 'obs_010'
param_exp['da_type'] = 'test'
