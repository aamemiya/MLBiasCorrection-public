...
id_exp="optuna_test_list"
recurrent=0
nntype="Dense_single"

python Exp.py -id $id_exp --use_optuna 1 --t "optimize" -osql $id_exp -nt 10 -e 10 -l 1 -ts 5 -ncdf_loc $loc -tb 32768 -nbs 8 -rec $recurrent -vb 8192 -norm 0 -d 1 -afm 0 --network_type "$nntype" -sprd 1 --list_layers "list_layers/1000/log_Dense"
